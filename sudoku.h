...
// effects:  mutates *s
// time: O(n^2), this is becuase i have two nested loops
...
// time: O(n^2), this is becuase this function calls a function that is n^2
...
// time: O(n^2), this is becuase the loops are 2 times nested
...
// and returns false otherwise.
// effects: mutates *s
// time: O(n^2), this is becuase this calls a n^2 function 
